...
uint256 hashGenesisBlock("0x77329107ed2bea2379313de2c4d6427b3c333f16f6ae473e0ef8ca92083ba989");
...
const string strMessageMagic = "CpgCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // CpgCoin: 1 days
static const int64 nTargetSpacing = 120; // CpgCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal cpgcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CpgCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "This is the Artificial Intelligence CPCGOLD coin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1478081115; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1066315;

        if (fTestNet)
        {
            block.nTime    = 1478081115;
            block.nNonce   = 68049;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x60112729c5a58c96e3f19ee35f09852939f6994b342783ed35e76668a5644ae3"));
